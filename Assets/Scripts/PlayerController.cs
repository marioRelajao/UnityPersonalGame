...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //transform.position += new Vector3(movementInput.x, movementInput.y, 0f)*Time.deltaTime*movementSpeed; //El deltatime es necesario para ser independientes del framerate
